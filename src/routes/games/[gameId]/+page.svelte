				...
				<div class="max-w-4xl mx-auto p-6">
					<div class="flex justify-between items-start mb-4">
						<div class="flex-1">
							...
							<!-- Game Meta -->
							<div
								class="game-meta flex flex-wrap items-center gap-4 text-sm"
							...
							{#if game.tags && game.tags.length > 0}
								<div class="game-tags mt-3 flex flex-wrap gap-2">
									{#each game.tags as tag}
										<span
											class="tag px-2 py-1 text-xs rounded-full bg-blue-100-theme text-blue-700-theme"
										>
											{tag}
										</span>
									{/each}
					...
					<div class="game-info-column">
						...
						<div class="card p-6 mb-6">
							...
							<div class="game-stats grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
								...
								>
									...
									<div class="stat-label text-sm" style="color: var(--text-secondary);">
										Locations
									</div>
								</div>
								<div
						...
						<div class="card p-6 mb-6">
							...
							<div class="creator-info flex items-center gap-4 mb-4">
								...
								<div class="flex-1">
									<div
										class="creator-name font-semibold text-lg"
										style="color: var(--text-primary);"
									>
										{game.createdBy}
									</div>
									<div class="creator-date text-sm" style="color: var(--text-tertiary);">
							...
							<!-- Creator Stats -->
							<div
								class="creator-stats grid grid-cols-2 gap-3 pt-3 border-t"
								style="border-color: var(--border-color);"
							>
								<div class="stat text-center">
									<div class="stat-value text-xl font-bold text-blue-600">
										{creatorGameCount || '...'}
									</div>
									<div class="stat-label text-xs" style="color: var(--text-tertiary);">Games</div>
								</div>
								<div class="stat text-center">
									<div class="stat-value text-xl font-bold text-green-600">
										{formatPlayCount(game.playCount)}
									</div>
						...
						<div class="card p-6">
							...
							<div class="game-details-grid space-y-3">
								<div
									class="detail-row flex justify-between items-center py-2 border-b"
									style="border-color: var(--border-color);"
								>
									<span class="detail-label text-sm" style="color: var(--text-secondary);"
										>Difficulty</span
									>
									<span
										class="detail-value font-medium capitalize"
										style="color: var(--text-primary);"
									>
							...
							{#if game.tags && game.tags.length > 0}
								<div
									class="tags-section mt-4 pt-4 border-t"
									style="border-color: var(--border-color);"
								>
