	...
	async function processFiles(files: FileList | File[]) {
		...
		for (let i = 0; i < files.length; i++) {
			...
			try {
				...
				invalidFiles.push(
					`${file.name}: Processing error - ${error instanceof Error ? error.message : 'Unknown error'}`
				);
			}
		}
					...
					<div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
						...
						<div class="xl:col-span-1 space-y-6">
							...
							<div
								...
								style="background-color: var(--bg-primary); border-color: {dragActive
									? '#60a5fa'
									: 'var(--border-color)'};  min-height: 220px;"
							...
							>
								{#if processingFiles}
									<div class="processing-indicator">
										...
										<p class="text-sm" style="color: var(--text-secondary);">
											Extracting GPS data and creating previews
										</p>
								...
								{:else}
									<div class="upload-content">
										<div
											class="text-4xl mb-4 transition-transform duration-300"
										...
										<div class="space-y-2">
											...
											<div class="text-xs" style="color: var(--text-secondary);">
												<p class="font-medium">
													✨ Multi-select: Ctrl+Click, Shift+Click, or Ctrl+A
												</p>
												<p class="mt-1">
													JPG, PNG, WebP, HEIC • Max {MAX_FILE_SIZE / 1024 / 1024}MB • Ctrl+U to
													upload
												</p>
											</div>
										</div>
							...
							{#if uploadFiles.length === 0}
								...
								>
									...
									<p class="text-sm mb-6" style="color: var(--text-secondary);">
										💡 <strong>Tip:</strong> Hold Ctrl (or Cmd) and click to select multiple photos at
										once
									</p>
									<button
...
{#if showLocationEditor}
	...
	>
		...
		>
			<div
				class="modal-header p-6 border-b"
			...
			>
				...
				<p style="color: var(--text-secondary);">
					Click on the map to mark where this photo was taken
				</p>
			</div>
			...
			<div class="modal-content p-6">
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
					...
					<div class="photo-section">
						{#if selectedFileIndex !== null}
							<div class="space-y-4">
								...
								<div
									class="photo-details rounded-xl p-4"
					...
					<div class="map-section">
						...
						<div
							class="mt-4 text-sm bg-blue-50 rounded-lg p-3"
			...
			<div
				class="modal-footer p-6 border-t flex justify-end gap-4"
				style="background-color: var(--bg-secondary); border-color: var(--border-color);"
			>
				<button
